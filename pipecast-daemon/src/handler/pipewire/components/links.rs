...
pub(crate) trait LinkManagement {
    async fn link_create_type_to_type(&mut self, source: LinkType, target: LinkType) -> Result<()>;

    async fn link_create_node_to_node(&mut self, source: Ulid, target: Ulid) -> Result<()>;
    async fn link_create_node_to_filter(&mut self, source: Ulid, target: Ulid) -> Result<()>;
    async fn link_create_node_to_unmanaged(&mut self, source: Ulid, target: u32) -> Result<()>;

    async fn link_create_filter_to_node(&mut self, source: Ulid, target: Ulid) -> Result<()>;
    async fn link_create_filter_to_filter(&mut self, source: Ulid, target: Ulid) -> Result<()>;
    async fn link_create_filter_to_unmanaged(&mut self, source: Ulid, target: u32) -> Result<()>;

    async fn link_create_unmanaged_to_node(&mut self, source: u32, target: Ulid) -> Result<()>;
    async fn link_create_unmanaged_to_filter(&mut self, source: u32, target: Ulid) -> Result<()>;
    async fn link_create_unmanaged_to_unmanaged(&mut self, source: u32, target: u32) -> Result<()>;


    async fn link_remove_type_to_type(&mut self, source: LinkType, target: LinkType) -> Result<()>;

    async fn link_remove_node_to_node(&mut self, source: Ulid, target: Ulid) -> Result<()>;
    async fn link_remove_node_to_filter(&mut self, source: Ulid, target: Ulid) -> Result<()>;
    async fn link_remove_node_to_unmanaged(&mut self, source: Ulid, target: u32) -> Result<()>;

    async fn link_remove_filter_to_node(&mut self, source: Ulid, target: Ulid) -> Result<()>;
    async fn link_remove_filter_to_filter(&mut self, source: Ulid, target: Ulid) -> Result<()>;
    async fn link_remove_filter_to_unmanaged(&mut self, source: Ulid, target: u32) -> Result<()>;

    async fn link_remove_unmanaged_to_node(&mut self, source: u32, target: Ulid) -> Result<()>;
    async fn link_remove_unmanaged_to_filter(&mut self, source: u32, target: Ulid) -> Result<()>;
    async fn link_remove_unmanaged_to_unmanaged(&mut self, source: u32, target: u32) -> Result<()>;
}
